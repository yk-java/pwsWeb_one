	...
	for(var i = 0; i < tds.length; i++) {
		...
		if (dateArray[i]){
			tds[i].onclick = function () {
				...
				calendar.hide();
				if(calendar.dateSelectedFn){
					calendar.dateSelectedFn(calendar.dateControl);
				}
			};
...
Calendar.prototype.show = function (dateControl, popuControl,e, dateSelectedFn) {
	...
	this.dateSelectedFn=dateSelectedFn;
...
document.writeln('<div id="__calendarPanel" style="position:absolute;left:0px;top:-220px; visibility:hidden;z-index:9999;background-color:#FFFFFF;border:1px solid #666666;width:200px;height:208px;">');
...
__ci.document.writeln('td {font-size:12px;text-align:center;line-height:14px;}');
...
__ci.document.writeln('input.b {border: 1px solid #CCCCCC;background-color:#EFEFEF;width:100%;height:20px;font-size:12px;}');
__ci.document.writeln('-->');
