 ...
 */
package com.glens.eap.platform.afinal;
...
import com.glens.eap.platform.afinal.http.AjaxCallBack;
import com.glens.eap.platform.afinal.http.AjaxParams;
import com.glens.eap.platform.afinal.http.HttpHandler;
import com.glens.eap.platform.afinal.http.RetryHandler;
import com.glens.eap.platform.afinal.http.SyncRequestHandler;
import com.glens.eap.platform.afinal.http.entityhandler.EntityHandler;
...
public class FinalHttp {
    ...
    public FinalHttp() {
        ...
        entityHandler = new StringEntityHandler();
    }
  ...
  //------------------put 请求-----------------------
    ...
    protected Object sendSyncRequest(DefaultHttpClient client, HttpContext httpContext, HttpUriRequest uriRequest, String contentType) {
        ...
        return new SyncRequestHandler(client, httpContext,charset, entityHandler).sendRequest(uriRequest);
    }
