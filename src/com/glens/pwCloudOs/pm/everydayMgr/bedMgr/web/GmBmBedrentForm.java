...
@ValueObjectProcessor(clazz = "com.glens.pwCloudOs.pm.everydayMgr.bedMgr.vo.GmBmBedrentVo")
public class GmBmBedrentForm extends ControllerForm {
    /**
	...
	protected Map doPreToMap() {
		...
		//判断是否是区域经理
		GmBmBedrentController bedrentController = (GmBmBedrentController) getController();
		UserToken token = bedrentController.getToken(getRequest());
