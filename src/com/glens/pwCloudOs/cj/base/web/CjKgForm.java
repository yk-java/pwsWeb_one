...
@ValueObjectProcessor(clazz = "com.glens.pwCloudOs.cj.base.vo.CjKg")
public class CjKgForm extends ControllerForm {
    ...
    public void setKglx(String kglx) {
        this.kglx = kglx == null ? null : kglx.trim();
    }
