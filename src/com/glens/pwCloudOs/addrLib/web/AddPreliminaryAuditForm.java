...
@ValueObjectProcessor(clazz="com.glens.pwCloudOs.addrLib.vo.AddPreliminaryAuditVo")
public class AddPreliminaryAuditForm extends ControllerForm {
	...
	protected Map doPreToMap() {
		...
		params.put("acceptSuggest", acceptSuggest);
		params.put("acceptTime", acceptTime);
		params.put("acceptorName", acceptorName);
		params.put("acceptorCode", acceptorCode);
		...
		params.put("appOrgTel", appOrgTel);
		params.put("applicatName", applicatName);
		...
		params.put("auditTime2", auditTime2);
		params.put("auditorName2", auditorName2);
		params.put("auditorCode2", auditorCode2);
		params.put("auditSuggest2", auditSuggest2);
		params.put("auditStatus2", auditStatus2);
		params.put("auditTime", auditTime);
		params.put("auditorName", auditorName);
		params.put("auditorCode", auditorCode);
		params.put("auditSuggest", auditSuggest);
		params.put("auditStatus", auditStatus);
		
		params.put("appOrgName", appOrgName);
		params.put("appOrgCode", appOrgCode);
		params.put("applicatTel", applicatTel);
